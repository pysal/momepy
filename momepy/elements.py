...
def tessellation(buildings, unique_id='uID', cut_buffer=50):
    ...
    buildings : GeoDataFrame
        geopandas gdf containing building footprints
    unique_id : str
...
def snap_street_network_edge(network, buildings, tessellation, tolerance_street, tolerance_edge):
    ...
    tessellation : GeoDataFrame
        geopandas gdf containing morphological tessellation
...
def blocks(cells, streets, buildings, id_name, unique_id):
    ...
    streets : GeoDataFrame
        geopandas gdf containing street network
    buildings : GeoDataFrame
        geopandas gdf containing buildings
    id_name : str
    ...
    cells : GeoDataFrame
        geopandas gdf containing morphological tessellation with added block ID
    blocks : GeoDataFrame
        geopandas gdf containing generated blocks
    """
...
def get_network_id(buildings, streets, tesselation, unique_id_column, network_id_column):
    ...
    buildings : GeoDataFrame
        geopandas gdf containing buildings
    streets : GeoDataFrame
        geopandas gdf containing street network with unique network ID.
    ...
    cells : GeoDataFrame
        geopandas gdf containing morphological tessellation with added network ID
