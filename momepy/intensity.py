...
def covered_area_ratio(left, right, left_areas, right_areas, unique_id):
    ...
    Examples
    --------
    >>> tessellation_df['CAR'] = mm.covered_area_ratio(tessellation_df, buildings_df, 'area', 'area', 'uID')
    Calculating covered area ratio...
    Merging DataFrames...
    Calculating CAR...
    Covered area ratio calculated.
    """
...
def floor_area_ratio(left, right, left_areas, right_areas, unique_id):
    ...
    left_areas : str, list, np.array, pd.Series
        the name of the left dataframe column, np.array, or pd.Series where is stored area value.
    right_areas : str, list, np.array, pd.Series
        the name of the right dataframe column, np.array, or pd.Series where is stored **floor** area value.
    unique_id : str
        name of the column with unique id shared amongst left and right gdfs.
        If there is none, it could be generated by :py:func:'momepy.unique_id()'.
    ...
    Examples
    --------
    >>> tessellation_df['FAR'] = mm.covered_area_ratio(tessellation_df, buildings_df, 'area', 'floor_area', 'uID')
