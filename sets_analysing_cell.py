...
# S - cell - dimension
buildings = gpd.read_file("/Users/martin/Dropbox/StrathUni/PhD/Sample Data/Prague/Character sets/s_tessellation_dimension.shp")
...
values = ['area', 'lal', 'perimet', 'bboxarea', 'bboxper', 'bboxwid', 'bboxlen', 'circle_r',
          'ch_area', 'ch_perim']
...
# corr = pd.read_csv('/Users/martin/Dropbox/StrathUni/PhD/00_Core Chapters/06 Identification of urban tissues/Characters subset testing/s_building_dimension_corr.csv')
...
plt.savefig('/Users/martin/Dropbox/StrathUni/PhD/00_Core Chapters/06 Identification of urban tissues/Characters subset testing/s_building_dimension_corr.png', dpi=300, bbox_inches='tight')
...
#           'ch_area', 'ch_perim', 'formf', 'fractal', 'vfr', 'circom', 'squcom', 'convex', 'corners', 'shape', 'squ', 'eri', 'elo', 'ccd']
#
# corr = buildings[values].corr()
# # corr.to_csv('/Users/martin/Dropbox/StrathUni/PhD/00_Core Chapters/06 Identification of urban tissues/Characters subset testing/s_building_shape_corr.csv')
#
# # Generate a mask for the upper triangle
# mask = np.zeros_like(corr, dtype=np.bool)
# mask[np.triu_indices_from(mask)] = True
...
#               'courtyards', 'bounding rectangle area', 'bounding rectangle perimeter',
#               'bounding rectangle width', 'bounding rectangle length',
#               'enclosing circle radius', 'convex hull area', 'convex hull perimeter', 'form factor', 'fractal dimension', 'volume - facade ratio',
...
#                 xticklabels=new_labels, yticklabels=new_labels)
#
# plt.savefig('/Users/martin/Dropbox/StrathUni/PhD/00_Core Chapters/06 Identification of urban tissues/Characters subset testing/s_building_corr.png', dpi=300, bbox_inches='tight')
